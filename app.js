...
function changeNavButtonsPosition () {
  ...
  swiperbuttonnext2.style.transform = 'translateY(1200%)';
  swiperbuttonprev2.style.transform = 'translateY(1200%)';

  swiperbuttonnext3.style.transform = 'translateY(2650%)';
  swiperbuttonprev3.style.transform = 'translateY(2650%)';
